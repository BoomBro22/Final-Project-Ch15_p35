...
//                centerP = new Point2D(w / 2, h / 2);
        ...
        private void setPrefHeight(double h2) {
		...
		private void setPrefWidth(double w2) {
			// TODO Auto-generated method stub
        ...
        private void checkBorder(Point2D p) {
            ...
            if (x <= 0 || x >= w) setHasHitBorder(true);
            if (y <= 0  || y >= h) setHasHitBorder(true);
        }
		...
		public void setHasHitBorder(boolean hasHitBorder) {
			this.hasHitBorder = hasHitBorder;
		}
